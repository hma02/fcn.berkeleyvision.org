...
image = Image.open('demo/image.jpg')
...
label = Image.open('demo/label.png')
...
imsave('demo/label_thr.png',label)

# load net
net = caffe.Net('hair-mn/deploy.prototxt', 'hair-mn/mobilenet_iter_25000.caffemodel', caffe.TEST)
# shape for input (data blob is N x C x H x W), set data
net.blobs['data'].reshape(1, *in_.shape)
net.blobs['data'].data[...] = in_
# run net and take argmax for prediction
net.forward()
out = net.blobs['output/relu/sep'].data[0]
